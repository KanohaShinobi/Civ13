...
/process/supplydrop/fire()
	for (var/l in 1 to 2)
		...
		switch (l)
			...
			if (3)
				objects = supplydrop_processing_objects_japan
				dropspots = japan_supplydrop_spots
			if (4)
				objects = supplydrop_processing_objects_american
				dropspots = american_supplydrop_spots
...
/process/supplydrop/statProcess()
	..()
	stat(null, "[supplydrop_processing_objects_german.len+supplydrop_processing_objects_soviet.len+supplydrop_processing_objects_japan.len+supplydrop_processing_objects_american.len] paths")

/process/supplydrop/htmlProcess()
	return ..() + "[supplydrop_processing_objects_german.len+supplydrop_processing_objects_soviet.len+supplydrop_processing_objects_japan.len+supplydrop_processing_objects_american.len] paths"
